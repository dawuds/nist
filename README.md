...
Layers 3-6 (implementation guidance, evidence requirements, artifacts, and risk management) contain AI-generated indicative content marked with `sourceType: "constructed-indicative"` in their `_meta` fields. This content is intended as a practical starting point for compliance programs and must be adapted to reflect organization-specific context, risk appetite, and regulatory obligations. It does not constitute professional legal or compliance advice.
